...
<head>
    ...
    <title>Finance & History Lab</title>
    <style>
        :root {
...
<script>
    const data = [
        { word: "less", def: "A smaller amount of (for uncountable things).", sents: ["I wish I had ___ stress in my life.", "We need ___ sugar in this recipe."] },
        { word: "trailing", def: "Being behind something or someone in a competition.", sents: ["The company is ___ its competitors in sales.", "Our team was ___ by ten points at halftime."] },
        { word: "due to", def: "Because of; caused by.", sents: ["The game was cancelled ___ the rain.", "His success is ___ hard work."] },
        { word: "gunpowder", def: "An explosive powder used in guns and fireworks.", sents: ["___ was invented in China many centuries ago.", "The barrel was filled with black ___."] },
        { word: "paperwork", def: "Routine work involving forms or reports.", sents: ["I spent all morning doing ___ for the bank.", "There is always so much ___ when you buy a house."] },
        { word: "suppliers", def: "Companies that provide products to businesses.", sents: ["We are looking for cheaper ___ for our restaurant.", "The ___ delivered the goods on time."] },
        { word: "often", def: "Frequently; many times.", sents: ["How ___ do you visit your family?", "I ___ drink tea in the afternoon."] }
    ];
    ...
    function init() {
        ...
        shuffle(pPool);
        document.getElementById('pron-content').innerHTML = pPool.map((s, i) => `<div class="gap-sentence">${s.t.replace(s.a, '_________')} <button class="mic-btn" onclick="testSpeech('${s.a}', 'p-fb-${i}')">🎤</button><div id="p-fb-${i}" style="font-size: 0.85em; color:#888; margin-top:5px;">Identify the missing word & speak!</div></div>`).join('');
    }
